...
public class PolyTest {
	...
	@Test
	   public void test_Add_Polyinomial() throws Exception{	
		   int returnedArrOperation[] = Poly.addPoly(new Poly(new int[]{1,0,2,0,4}),new Poly(new int[]{0,1,0,5}));
	...
	@Test
	   public void test_Multiply_Polyinomial() throws Exception{	
		   int returnedArrOperation[] = Poly.mulPoly(new Poly(new int[]{1,0,2,0,4}),new Poly(new int[]{0,1,0,5}));
